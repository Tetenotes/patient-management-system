...
<html lang="en">
<head>
<title>STANFORD UNIVERSITY HOSPTAL</title> 
<!-- For-Mobile-Apps-and-Meta-Tags -->
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="STANFORD UNIVERSITY HOSPTAL, Located next to Caltech, buydrugs" />
	...
	<div class="overlay overlay-simplegenie">
		...
		<section class="header-w3ls"> 
			...
			<a class="page-scroll" href="doctorlogin.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Doctor Login</a>
                        <a class="page-scroll" href="admin.php" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Admin Login</a>
                        
			</div>
		<h1><a href="main.html">STANFORD UNIVERSITY HOSPTAL</a></h1>
	...
	<div class="footer">
		<div class="agileinfo_footer_bottom1">
			<div class="container">
					...
					<p>| Developed by Group 8<a href="#">section 002</a></p>
				<div class="clearfix"> </div>
			</div>
		</div>
	</div>
